...
int main() {
    ...
    while(1) {
        ...
        sprintf(query, "INSERT INTO Address (zip_code, street, street_number, city) VALUES (\'%s\', \'%s\', \'%s\', %s); INSERT INTO AddCust (customer, zip_code, street, street_number) VALUES (\'%s\', \'%s\', \'%s\', \'%s\');", 
                        address->zip_code, address->street, address->street_number, address->city, 
                        address->email, address->zip_code, address->street, address->street_number);
